function text_animation(term) {
    ...
    intro_frames = [
        " Salut [[b;;]" + user + "],\n",
        "   Je suis le developpeur [[b;;]Crystof5] qui est entrainde modifier cette plateforme",
        " ",
        "  je dois franciser, donc ceci est un test avant d'avoir un vrai scenario",
        "  ---------------------------------------------------------------------.",
        " ",
        "  -------------------------- \"Missions\" f-----------------------------.",
        "  --------------------------$" + reward + " -----------------",
...
function loading(term) {
    ...
    var count = 0;
    loading_bar = ["|", "/", "-", "\\"];
    message = " > Établissement d'un canal de communication sécurisé, veuillez patienter ...  ";
